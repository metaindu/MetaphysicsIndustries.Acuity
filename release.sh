...
if ! nuget pack MetaphysicsIndustries.Acuity.nuspec -Properties version=$DVERSION ; then
...
if ! nuget push MetaphysicsIndustries.Acuity.$DVERSION.nupkg -Source nuget.org -ApiKey $NUGET_API_KEY ; then
